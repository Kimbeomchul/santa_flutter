              ...
              SliverList(
                delegate: SliverChildListDelegate([
                  Padding(
                    ...
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: <Widget>[Text("산타는 등산에 관한 정보제공 및 공유를 하는 커뮤니티 형식의 애플리케이션입니다. 원하시는 기능이나 정보를 아래에 있는 개발자에게 전달해 주시면 빠르게 적용하도록 하겠습니다.",
                          ...
                          children: [
                            ...
                            IconButton(
                              // Use the MdiIcons class for the IconData
                                icon: new Icon(MdiIcons.instagram,color: Colors.grey,),
                                onPressed: () {
                                  launch('https://www.instagram.com/dupyo_91/', forceWebView: true, forceSafariVC: true); //두깨 인스타
                                }
                            ),
                            IconButton(
                              // Use the MdiIcons class for the IconData
                        ...
                        SizedBox(height: 10,),
                            Text("Frontend : Thymeleaf , Vuejs , Flutter(Webview)", style: TextStyle(color: Colors.grey),
                        ),
